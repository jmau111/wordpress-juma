...
add_action( 'wp_enqueue_scripts', 'wordpress_juma_font' );
 ...
 * @return void
 */
function wordpress_juma_editor_font() {
	add_editor_style(
		wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap' ),
	);
}
add_action( 'after_setup_theme', 'wordpress_juma_editor_font' );
